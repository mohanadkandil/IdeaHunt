    ...
    <div className="flex justify-center py-10">
      <div className="flex flex-col justify-center items-center py-10">
        <div className="flex flex-col space-y-6">
          <div className="text-5xl relative flex justify-center font-medium leading-6 text-white">
            <span>
              Let&apos;s validate your{" "}
              <span className="text-[#00B389] font-bold">idea</span>
              <div className="rotate-45 absolute right-0 -top-6 -mx-20">
                <Lightbulb className="w-[75px] h-[75px]" />
              </div>
            </span>
          </div>
